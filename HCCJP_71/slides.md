...
| 軸 | 問い |
|----|------|
| **1. 実行環境** | AIエージェントを**どこで**動かすか？ |
| **2. コンテキスト** | 情報を**どこに**持つか？ |
| **3. エージェントソフト** | **どのソフト**でエージェントを動かすか？ |
| **4. モデル** | **どのLLM**で推論するか？ |

この4軸の組み合わせで、無数のパターンが生まれる
...
| ツール | 実行環境 | コンテキスト | エージェントソフト | モデル |
|--------|---------|-------------|-----------------|--------|
| Claude Code | ローカル | ローカル+クラウドAPI | Claude Code | Anthropic |
| Claude on Web | クラウド | クラウド | Claude.ai | Anthropic |
| Cursor | ローカル | ローカル | Cursor | マルチ選択可 |
| Windsurf | ローカル | ローカル | Windsurf | マルチ選択可 |
| GitHub Copilot CLI | ローカル | ローカル+GitHub | Copilot CLI | マルチ選択可 |
| Copilot Coding Agent | クラウド | GitHub | Copilot Agent | マルチ選択可 |
| Devin | クラウド | クラウド | Devin | マルチ |
| OpenHands | ローカル/クラウド | ローカル | OpenHands | マルチ選択可 |
...
3. **4軸**（実行環境・コンテキスト・エージェントソフト・モデル）で整理できる
